...
// NÃO há verificação do período de inscrição nesta página
...
<div class="container" id="formContainer">
  ...
  <form id="registrationForm" action="process_admin.php" method="POST">
...
<script>
  ...
  // Atualização de oficinas em tempo real (SSE ou fallback)
